...
let myFirstVehicle = new Vehicle('4', 'black', 90000);
//Code Here
...
//Code Here
let myFirstMotorcycle = new Motorcycle('2', 'blue', 9000, 'Yamaha', true);
...
class Boat extends Vehicle {
	...
	checkSeaworthiness() {
		if (this.isSeaworthy) {
			console.log(
				`The ${this.color}$ {this.type} ${this.name} is searthy!`,
			);
		} else {
...
//Code Here
let Boaty = new Boat(1, 'white n red', '3000', 'BoatsnHowls', 'Yamaha', true);
/*
